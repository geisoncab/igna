<?php
    ob_start();
    session_start();
    require '../modelos/ComisionesSelectMinisterio.php';
    ...
    if($_POST){
        ...
        $instancia = new ComisionesSelectMinisterio();
        ...
        switch($_POST["accion"]){
            ...
            case "CONSULTAR":
                ...
                foreach($rspta AS $reg){
                    $data[]=array(
                        "0"=>$reg->nombre,
                        "1"=>'<a class="btn btn-light" href="../vistas/comisiones.php?idministerios='.$reg->idministerios.'"><i class="fas fa-hand-pointer"></i></a>'
                    );
                }
                $results = array(
