        ...
        switch($_POST["accion"]){
            ...
            case "CONSULTAR":
                ...
                foreach($rspta AS $reg){
                    $data[]=array(
                        "0"=>$reg->nombre,
                        "1"=>'<button class="btn btn-light" onClick="ConsultarPorId('. $reg->ididiomas .');"><i class="fas fa-eye"></i></button>'.
                            '<button class="btn btn-light" onClick="Eliminar('. $reg->ididiomas .');"><i class="fa fa-trash"></i></button>'
                    );
                }
                $results = array(
            ...
            case 'CONSULTAR_ID':
                ...
                $ididiomas=$_POST['ididiomas'];
                $rspta=$instancia->ConsultarPorId($ididiomas);
            ...
            case "GUARDAR":
                ...
                if(empty($ididiomas)){
                    ...
                    //update
                    $respuesta = $instancia->Modificar($ididiomas, $nombre, $usuario_modifico, $fecha_modifico);
            ...
            case "ELIMINAR":
                $ididiomas=$_POST['ididiomas'];
                $respuesta = $instancia->Eliminar($ididiomas);
