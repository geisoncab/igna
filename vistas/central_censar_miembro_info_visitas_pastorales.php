...
?>
    ...
    <div class="content-wrapper overflow-auto" style="height:100%;">
        ...
        <div class="container-fluid">
            <div class="row mb-2 ">
            <div class="col-sm-6">
                <h1 class="m-0">VISITAS PASTORALES</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Visitas pastorales</li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="modal-content">
                            <form name="formulario" id="formulario" method="POST">
                                <div class="modal-header">
                                    ...
                                    <input type="hidden" id="idvisitaspastorales" name="idvisitaspastorales" readonly>
...
<script type="text/javascript" src="js/central_censar_miembro_info_visitas_pastorales.js"></script>
