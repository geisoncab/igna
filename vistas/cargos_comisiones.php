...
?>
    ...
    <div class="content-wrapper overflow-auto" style="height:100%;">
        ...
        <div class="container-fluid">
            <div class="row mb-2 ">
            <div class="col-sm-6">
                <h1 class="m-0">CARGOS DE COMISIONES</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="inicio.php">Incio</a></li>
                <li class="breadcrumb-item active">Cargos de comisiones</li>
                </ol>
            </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="modal-content">
                            <form name="formulario" id="formulario" method="POST">
                                <div class="modal-header">
                                    ...
                                    <input type="text" id="idcargoscomisiones" name="idcargoscomisiones" readonly>
                                </div>
...
<script type="text/javascript" src="js/cargos_comisiones.js"></script>
