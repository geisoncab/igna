    ...
    <div class="content-wrapper overflow-auto" style="height:100%;">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item"><a href="comisiones_select_ministerio.php">Comisiones: seleccionar ministerio</a></li>
                        ...
                        <div class="modal-content">
                            <form name="formulario" id="formulario" method="POST">
                                <div class="modal-header">
                                    ...
                                    <input type="hidden" id="idministerios" name="idministerios" readonly>
                                    <input type="hidden" id="idcomisiones" name="idcomisiones" readonly>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                        <!-- <select id="idministerios" name="idministerios" title="Seleccione ministerios" class="form-select selectpicker" data-live-search="true" data-style="btn-success" required> -->
                                        <!-- <select id="idministerios" name="idministerios" title="Seleccione ministerios" class="form-select" required>
                                        </select> -->
                                    </div>
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
