    ...
    tabla=$('#tablaDatos').dataTable(
        {
            ...
            "ajax":
                    {
                        url: '../controladores/ocupaciones.php',
...
const ConsultarPorId = async (idocupaciones) =>{

	$.ajax({
        url: "../controladores/ocupaciones.php",
        data: {"idocupaciones":idocupaciones, "accion": "CONSULTAR_ID"},
        type: 'POST',
        dataType: 'json'
...
const Eliminar = async (idocupaciones) =>{
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../controladores/ocupaciones.php",{
                accion : 'ELIMINAR',
