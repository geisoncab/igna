    ...
    tabla=$('#tablaDatos').dataTable(
        {
            ...
            "ajax":
                    {
                        url: '../controladores/cargos_comisiones.php',
...
const ConsultarPorId = async (idcargoscomisiones) =>{

	$.ajax({
        url: "../controladores/cargos_comisiones.php",
        data: {"idcargoscomisiones":idcargoscomisiones, "accion": "CONSULTAR_ID"},
        type: 'POST',
        dataType: 'json'
        ...
        //carga datos
        $('#idcargoscomisiones').val(response.idcargoscomisiones);
...
const Eliminar = async (idcargoscomisiones) =>{
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../controladores/cargos_comisiones.php",{
                accion : 'ELIMINAR',
