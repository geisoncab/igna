...
console.log('bt ' + $.fn.selectpicker.Constructor.BootstrapVersion);
    ...
    tabla=$('#tablaDatos').dataTable(
        {
            ...
            "ajax":
                    {
                        url: '../controladores/ministerios.php',
...
const ConsultarPorId = async (idministerios) =>{

	$.ajax({
        url: "../controladores/ministerios.php",
        data: {"idministerios":idministerios, "accion": "CONSULTAR_ID"},
        type: 'POST',
        dataType: 'json'
...
const Eliminar = async (idministerios) =>{
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../controladores/ministerios.php",{
                accion : 'ELIMINAR',
