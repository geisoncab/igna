...
const ConsultarPorId = async (ididiomas) =>{

	$.ajax({
        url: "../controladores/idiomas.php",
        data: {"ididiomas":ididiomas, "accion": "CONSULTAR_ID"},
        type: 'POST',
        dataType: 'json'
        ...
        //carga datos
        $('#ididiomas').val(response.ididiomas);
...
const Eliminar = async (ididiomas) =>{
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../controladores/idiomas.php",{
                accion : 'ELIMINAR',
                ididiomas: ididiomas
            }, function(response){
                if(response == "OK"){
