    ...
    tabla=$('#tablaDatos').dataTable(
        {
            ...
            "ajax":
                    {
                        url: '../controladores/misiones.php',
...
const ConsultarPorId = async (idmisiones) =>{

	$.ajax({
        url: "../controladores/misiones.php",
        data: {"idmisiones":idmisiones, "accion": "CONSULTAR_ID"},
        type: 'POST',
        dataType: 'json'
        ...
        //carga datos
        $('#idmisiones').val(response.idmisiones);
...
const Eliminar = async (idmisiones) =>{
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../controladores/misiones.php",{
                accion : 'ELIMINAR',
