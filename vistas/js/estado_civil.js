    ...
    tabla=$('#tablaDatos').dataTable(
        {
            ...
            "ajax":
                    {
                        url: '../controladores/estado_civil.php',
...
const ConsultarPorId = async (idestadocivil) =>{

	$.ajax({
        url: "../controladores/estado_civil.php",
        data: {"idestadocivil":idestadocivil, "accion": "CONSULTAR_ID"},
        type: 'POST',
        dataType: 'json'
        ...
        //carga datos
        $('#idestadocivil').val(response.idestadocivil);
...
const Eliminar = async (idestadocivil) =>{
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.post("../controladores/estado_civil.php",{
                accion : 'ELIMINAR',
