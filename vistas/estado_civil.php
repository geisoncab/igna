    ...
    <div class="content-wrapper overflow-auto" style="height:100%;">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <table id="tablaDatos" class="table display responsive nowrap  table-striped table-bordered table-condensed table-hover"style="width:100%">
                    <thead>
                    <th>NOMBRE</th>
                    <th>ACCIONES</th>
                    </thead>
                        ...
                        <div class="modal-content">
                            <form name="formulario" id="formulario" method="POST">
                                <div class="modal-header">
                                    ...
                                    <input type="hidden" id="idestadocivil" name="idestadocivil" readonly>
                                </div>
...
<script type="text/javascript" src="js/estado_civil.js"></script>
